...
\todo{section header? merge with agreements?}
...
The following bodies will form part of the \ac{AGP} process and are collectively referred to as the \gls{AragonNetworkDAO}, composed of a Main \ac{DAO} and Sub-\acp{DAO}. \todo{What is with Aragon Court?}

\subsection{Main \ac{DAO}}

\added{The Main \ac{DAO} is}
...
\added{The Executive Sub-\ac{DAO} is}
...
\added{The Compliance Sub-\ac{DAO} is}
...
\added{Proposals must pass through the following phases} in sequential order:
...
\added{Elections must pass through the following phases in sequential order.}
